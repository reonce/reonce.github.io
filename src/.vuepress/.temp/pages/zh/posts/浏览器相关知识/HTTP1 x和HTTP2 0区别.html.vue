<template><div><h1 id="http1-x和http2-0区别" tabindex="-1"><a class="header-anchor" href="#http1-x和http2-0区别" aria-hidden="true">#</a> HTTP1.x和HTTP2.0区别</h1>
...
<p>简单来说， 就是在同一个TCP连接，同一时刻可以传输多个HTTP请求。</p>
<blockquote>
