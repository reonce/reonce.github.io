...
<p>Vite开发模式单独实现了一套热更新（HMR - Hot Module Replacement），可是从<a href="https://link.zhihu.com/?target=https%3A//github.com/rollup/awesome" target="_blank" rel="noopener noreferrer">Rollup Awesome<ExternalLinkIcon/></a>中可以发现，Rollup有热更新插件<a href="https://link.zhihu.com/?target=https%3A//github.com/PepsRyuu/nollup" target="_blank" rel="noopener noreferrer">nollup<ExternalLinkIcon/></a>。为什么Vite不用Rollup的热更新呢？</p>
...
<p>也就是说Vite是第一个发布基于纯ESM的热更新。当时Rollup还没有纯ESM的热更新。</p>
<h2 id="三、vite为什么不用webpack" tabindex="-1"><a class="header-anchor" href="#三、vite为什么不用webpack" aria-hidden="true">#</a> 三、Vite为什么不用Webpack</h2>
<p>Webpack和Rollup功能差不多，以前有种说法是应用开发用Webpack，库开发用Rollup。但是现在Webpack也支持Tree shaking，Rollup也有热更新，而且都有强大的插件开发功能。二者的功能差异越来越模糊。</p>
<p><strong>二者更多的区别是在写法上。</strong></p>
<p>如下是Rollup的配置文件：</p>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面是webpack的配置文件：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// webpack.config.js
...
<p>Rollup使用起来更简洁，并且Rollup打出更小体积的文件，所以Rollup更适合Vite。</p>
</div></template>
