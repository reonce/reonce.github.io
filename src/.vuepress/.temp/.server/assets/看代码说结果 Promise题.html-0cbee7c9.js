...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="看代码说结果-promise题" tabindex="-1"><a class="header-anchor" href="#看代码说结果-promise题" aria-hidden="true">#</a> 看代码说结果 Promise题</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> p <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Promise</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">resolve<span class="token punctuation">,</span>reject</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/posts/手写算法系列/看代码说结果/看代码说结果 Promise题.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _______Promise__html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "看代码说结果 Promise题.html.vue"]]);
export {
  _______Promise__html as default
};
