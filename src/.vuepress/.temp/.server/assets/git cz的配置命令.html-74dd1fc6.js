...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="git-cz的配置命令" tabindex="-1"><a class="header-anchor" href="#git-cz的配置命令" aria-hidden="true">#</a> git cz的配置命令</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install -g commitizen；
