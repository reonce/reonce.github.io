...
class UI {
  ...
  init() {
    ...
    pswp.on("change", () => {
      var _a;
      (_a = pswp.element) == null ? void 0 : _a.classList[pswp.getNumItems() === 1 ? "add" : "remove"]("pswp--one-slide");
    });
...
class Opener {
  ...
  _initiate() {
    ...
    (_b = this.pswp.element) == null ? void 0 : _b.classList[this.isOpening ? "add" : "remove"]("pswp--ui-visible");
    if (this.isOpening) {
      if (this._placeholder) {
